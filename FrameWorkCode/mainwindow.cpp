    ...
    ui(new Ui::MainWindow)
{
    ...
    connect(bold, SIGNAL(triggered()), this, SLOT(bold_Checked()));

    //Add Menu
    QMenu *formatMenu = menuBar() -> addMenu("Text Format");
